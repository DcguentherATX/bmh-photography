            ...
            <Navbar className="navbar" sticky="top">
                ...
                <div className="nav-dropdown">
                    ...
                    >
                        ...
                        <Dropdown.Item className="drop" eventKey="4" value="all" onClick={props.handleDropdownClick} >All</Dropdown.Item>
                    </DropdownButton>
                </div>
                <div>
                    ...
                    >
                        ...
                        <Dropdown.Item className="final-drop" eventKey="10" value="total"><strong>Total: ${props.cartTotal}</strong></Dropdown.Item>
